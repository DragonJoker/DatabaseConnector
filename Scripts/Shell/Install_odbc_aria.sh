...
SET DRIVER_PATH=C:\Program Files\MySQL\Connector ODBC 5.2\myodbc5w.dll
SET DRIVER_DESCRIPTION=MySQL ODBC 5.2 Unicode Driver
SET DESCRIPTION=%1
...
:: Set common keys
CALL %~dp0Install_odbc.bat %SOURCE_NAME% "%SERVER%" "%DATABASE_NAME%" "%DRIVER_PATH%" "%DRIVER_DESCRIPTION%" "%DESCRIPTION%" %HKEY_REGISTRY%
