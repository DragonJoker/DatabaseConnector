...
public:
        ...
        */
        ...
        @param parameter
            The parameter
        */
        void operator()( sql::PreparedStatement * statement, void * value, CDatabaseStatementParameterSqlite * parameter )
        {
...
protected:
        ...
        @param parameter
            The parameter
        */
        virtual void DoSetValue( sql::PreparedStatement * statement, void * value, CDatabaseStatementParameterSqlite * parameter ) = 0;
    };
...
private:
        ...
        virtual void DoSetValue( sql::PreparedStatement * statement, void * value, CDatabaseStatementParameterSqlite * parameter )
        {
