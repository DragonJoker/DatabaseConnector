/************************************************************************//**
* @file DatabaseQueryParameterSqlite.h
...
#ifndef ___DATABASE_QUERY_PARAMETER_SQLITE_H___
#define ___DATABASE_QUERY_PARAMETER_SQLITE_H___
...
BEGIN_NAMESPACE_DATABASE_SQLITE
{
	...
	*/
	class CDatabaseQueryParameterSqlite
	...
	public:
		...
		@param[in] updater
		    The parent updater
		 */
		DatabaseSqliteExport CDatabaseQueryParameterSqlite( DatabaseConnectionSqlitePtr connection, const String & name, unsigned short index, EFieldType fieldType, EParameterType parameterType, std::unique_ptr< SValueUpdater > updater );
		...
		@param[in] updater
		    The parent updater
		 */
		DatabaseSqliteExport CDatabaseQueryParameterSqlite( DatabaseConnectionSqlitePtr connection, const String & name, unsigned short index, EFieldType fieldType, uint32_t limits, EParameterType parameterType, std::unique_ptr< SValueUpdater > updater );

		/** Destructor.
		 */
		DatabaseSqliteExport virtual ~CDatabaseQueryParameterSqlite();
