...
BEGIN_NAMESPACE_DATABASE_SQLITE
{
    namespace
    {
        ...
        struct SValueSetter
        {
            void operator()( SParameterValueSetterBase * paramSetter, U & value, sql::PreparedStatement * statement, CDatabaseStatementParameterSqlite * parameter, CDatabaseValueBase * paramValue )
            {
                T val = T( value );
        ...
        {
            void operator()( SParameterValueSetterBase * paramSetter, T & value, sql::PreparedStatement * statement, CDatabaseStatementParameterSqlite * parameter, CDatabaseValueBase * paramValue )
            {
                if ( statement )
                {
        ...
        {
            void operator()( SParameterValueSetterBase * paramSetter, bool & value, sql::PreparedStatement * statement, CDatabaseStatementParameterSqlite * parameter, CDatabaseValueBase * paramValue )
            {
                T val = value ? 1 : 0;
        ...
        {
            void operator()( SParameterValueSetterBase * paramSetter, const char * value, sql::PreparedStatement * statement, CDatabaseStatementParameterSqlite * parameter, CDatabaseValueBase * paramValue )
            {
                if ( statement )
                {
                    ( *paramSetter )( statement, ( void * )value, parameter );
        ...
        {
            void operator()( SParameterValueSetterBase * paramSetter, const wchar_t * value, sql::PreparedStatement * statement, CDatabaseStatementParameterSqlite * parameter, CDatabaseValueBase * paramValue )
            {
    ...
    CDatabaseStatementParameterSqlite::CDatabaseStatementParameterSqlite( DatabaseConnectionSqlitePtr connection, const String & name, unsigned short index, EFieldType fieldType, EParameterType parameterType, SValueUpdater * updater )
        ...
        , CDatabaseParameterSqlite( fieldType, parameterType )
        , _paramSetter( NULL )
        , _streamValue( NULL )
        , _streamBuffer( NULL )
        , _statement( NULL )
