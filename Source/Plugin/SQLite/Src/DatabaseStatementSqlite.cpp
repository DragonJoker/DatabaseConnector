...
BEGIN_NAMESPACE_DATABASE_SQLITE
{
    ...
    EErrorType CDatabaseStatementSqlite::Initialize()
    {
        ...
        sql::Connection * connection = _connectionSqlite->GetConnection();
        SQLiteTry( _statement.reset( connection->prepareStatement( CStrUtils::ToStr( _query ) ) ), STR( "Statement preparation" ) );
        ...
        {
            std::static_pointer_cast< CDatabaseStatementParameterSqlite >( *it )->SetStatement( _statement.get() );
        }
    ...
    DatabaseResultPtr CDatabaseStatementSqlite::ExecuteSelect( EErrorType * result )
    {
        ...
        DatabaseResultSqlitePtr pReturn;
        EErrorType eResult = EErrorType_NONE;
