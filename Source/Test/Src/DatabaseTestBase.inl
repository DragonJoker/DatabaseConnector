	...
	void CDatabaseTest::TestCase_DatabaseFieldsInsertRetrieve()
	{
		...
		if ( database )
		{
			...
			if ( connection && connection->IsConnected() )
			{
				...
				DatabaseUtils::InsertAndRetrieve< StmtType, int8_t >( connection, STR( "TinyIntField" ) );
				...
				DatabaseUtils::InsertAndRetrieve< StmtType, float >( connection, STR( "RealField" ) );
				...
				DatabaseUtils::InsertAndRetrieve< StmtType, CFixedPoint >( connection, STR( "NumericField" ) );
				DatabaseUtils::InsertAndRetrieve< StmtType, CFixedPoint >( connection, STR( "DecimalField" ) );
	...
	void CDatabaseTest::TestCase_DatabaseFieldsInsertRetrieveOtherIndex()
	{
		...
		if ( database )
		{
			...
			if ( connection && connection->IsConnected() )
			{
				...
				DatabaseUtils::InsertAndRetrieveOtherIndex< StmtType, int8_t >( connection, STR( "TinyIntField" ) );
				...
				DatabaseUtils::InsertAndRetrieveOtherIndex< StmtType, float >( connection, STR( "RealField" ) );
				...
				DatabaseUtils::InsertAndRetrieveOtherIndex< StmtType, CFixedPoint >( connection, STR( "NumericField" ) );
				DatabaseUtils::InsertAndRetrieveOtherIndex< StmtType, CFixedPoint >( connection, STR( "DecimalField" ) );
	...
	void CDatabaseTest::TestCase_DatabaseFieldsInsertRetrieveFast()
	{
		...
		if ( database )
		{
			...
			if ( connection && connection->IsConnected() )
			{
				...
				DatabaseUtils::InsertAndRetrieveFast< StmtType, int8_t >( connection, STR( "TinyIntField" ) );
				...
				DatabaseUtils::InsertAndRetrieveFast< StmtType, float >( connection, STR( "RealField" ) );
				...
				DatabaseUtils::InsertAndRetrieveFast< StmtType, CFixedPoint >( connection, STR( "NumericField" ) );
				DatabaseUtils::InsertAndRetrieveFast< StmtType, CFixedPoint >( connection, STR( "DecimalField" ) );
	...
	void CDatabaseTest::TestCase_DatabaseFieldsInsertRetrieveFastOtherIndex()
	{
		...
		if ( database )
		{
			...
			if ( connection && connection->IsConnected() )
			{
				...
				DatabaseUtils::InsertAndRetrieveFastOtherIndex< StmtType, int8_t >( connection, STR( "TinyIntField" ) );
				...
				DatabaseUtils::InsertAndRetrieveFastOtherIndex< StmtType, float >( connection, STR( "RealField" ) );
				...
				DatabaseUtils::InsertAndRetrieveFastOtherIndex< StmtType, CFixedPoint >( connection, STR( "NumericField" ) );
				DatabaseUtils::InsertAndRetrieveFastOtherIndex< StmtType, CFixedPoint >( connection, STR( "DecimalField" ) );
