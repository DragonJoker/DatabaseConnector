	...
	public:
		...
		*/
		...
		@return
		    Formatted value.
		*/
		DatabaseExport virtual std::string WriteDateTime( const CDateTime & dateTime ) const = 0;
		...
		@return
		    Formatted value.
		*/
		DatabaseExport virtual std::string WriteDateTime( const CDate & date ) const = 0;
